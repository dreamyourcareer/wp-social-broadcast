...
****************************************************************************
 ...
 Copyright 2014 "Karl Lillrud" www.WPSocialbroadcast.com and "Navnish Bhardwaj"
...
****************************************************************************
 * @author      Karl Lillrud <karl@lillrud.com>, Navnish Bhardwaj <ceo@dreamyourcareer.com>
...
if( isset($_GET['support']) && $_GET['support'] == 'yes' && $_GET['page'] == 'wordpress-social-broadcast')
{
...
<p>You can do a simple test to see if you meet the <a href="http://www.WPSocialbroadcast.com/docs" target="_blank">requirements</a>: <a class="button-primary" href="<?php echo $wsi->WPB_PLUGIN_URL.'/test.php';?>" target="_blank">TEST</a></p>

<p>Check first <a href="http://www.WPSocialbroadcast.com/faq/" target="_blank">Common Problems section</a></p>

<p>Enable DEV mode to see errors and fill the php error_log with more debugging info</p>

<p>WSI Server Cron url: <?php echo site_url('wp-cron.php').'?wsi_server_cron='.WSI_CRON_TOKEN;?>  <a href="http://www.WPSocialbroadcast.com/" target="_blank">View instructions</a> for server cron jobs</p>
