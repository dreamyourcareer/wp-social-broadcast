...
class Wsi_Widget extends WP_Widget {
	...
	function __construct() {
		$this->wsi = WP_Social_Broadcast::get_instance();
		$this->wpb_prefix = $this->wsi->get_domain();
		parent::__construct(
			'wsi_widget', // Base ID
			'Wordpress Social Broadcast', // Name
			array( 'description' => __( 'Add a WP Social Broadcast sidebar widget. Only icons are displayed', $this->wpb_prefix ), ) // Args
		);
	}
