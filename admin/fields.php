<?php
	...
	$this->settings['providers_heading'] = array(
		...
		'title'		=> '',
		'desc'   	=> "<p>".__('If you have <a href="http://buddypress.org/">Buddypress</a> or the <a href="http://wordpress.org/plugins/invite-anyone/">Invite Anyone plugin</a> installed, you will be able to hook Wordpress Social Broadcast into them from here.',$this->WPB_PREFIX)."</p><p>". __('Also if you wish you can set a redirection url to send users after they sent the broadcast to one of the providers',$this->WPB_PREFIX)."</p>",
		'class'	 	=> '',
		'type'   	=> 'heading'
	);
	 ...
	 if(!get_option('users_can_register') && !empty($bp)) :
		...
		$this->settings['bypass_registration_lock'] = array(
				...
				'desc'    => __( 'Your site is blocked for new registations. Check here to bypass this on new Broadcast' , $this->WPB_PREFIX),
				'std'     => '',
				'type'    => 'checkbox',
				'choices' => array(
	...
	$this->settings['redirect_url'] = array(
			'title'   => __( '"Redirect to" URL' , $this->WPB_PREFIX) . '<a href="http://www.WPSocialbroadcast.com" target="_blank" style="color:red"> (Premium Only)</a>',
			'desc'    => __( 'Users will be redirected to this url after they send broadcast' , $this->WPB_PREFIX),
			'std'     => '',
			'type'    => 'text',
			'disabled'=> 'yes',
			'section' => 'wsi_general'
	...
	$this->settings['enable_facebook'] = array(
		...
		'desc'    => __( 'Enable / Disable Facebook Broadcast.' , $this->WPB_PREFIX). 'This will post to Facebook\'s wall.',
		'std'     => 'false',
		'type'    => 'select',
		'section' => 'wsi_general',
		'choices' => array(
	...
	$this->settings['facebook_key'] = array(
		...
		'desc'    => sprintf(__( '<a href="%s" target="_blank">Where do i get this info?</a>' , $this->WPB_PREFIX), 'http://www.WPSocialbroadcast.com/' ),
		'std'     => '',
		'type'    => 'text',
		'section' => 'wsi_general'
	);
	...
	$this->settings['enable_twitter'] = array(
		'title'   => __( 'Enabled' , $this->WPB_PREFIX),
		'desc'    => __( 'Enable / Disable Twitter Broadcast.' , $this->WPB_PREFIX). 'This will post a tweet.',
		'std'     => 'false',
		'type'    => 'select',
		'section' => 'wsi_general',
		'choices' => array(
...
$this->settings['g_heading'] = array(
	...
	$this->settings['enable_google'] = array(
		'title'   => __( 'Enabled' , $this->WPB_PREFIX),
		'desc'    => __( 'Enable / Disable Google Broadcast.' , $this->WPB_PREFIX),
		'std'     => 'false',
		'type'    => 'select',
		'section' => 'wsi_general',
		'choices' => array(
	...
	$this->settings['enable_linkedin'] = array(
		'title'   => __( 'Enabled' , $this->WPB_PREFIX),
		'desc'    => __( 'Enable / Disable Linkedin Broadcast.' , $this->WPB_PREFIX). 'This will post to Linkedin\'s wall.',
		'std'     => 'false',
		'type'    => 'select',
		'section' => 'wsi_general',
		'choices' => array(
	...
	$this->settings['enable_yahoo'] = array(
		'title'   => __( 'Enabled' , $this->WPB_PREFIX),
		'desc'    => __( 'Enable / Disable Yahoo Broadcast.' , $this->WPB_PREFIX),
		'std'     => 'false',
		'type'    => 'select',
		'section' => 'wsi_general',
		'choices' => array(
	...
	$this->settings['enable_foursquare'] = array(
		'title'   => __( 'Enabled' , $this->WPB_PREFIX),
		'desc'    => __( 'Enable / Disable Foursquare Broadcast.' , $this->WPB_PREFIX),
		'std'     => 'false',
		'type'    => 'select',
		'section' => 'wsi_general',
		'choices' => array(
	...
	$this->settings['enable_live'] = array(
		'title'   => __( 'Enabled' , $this->WPB_PREFIX),
		'desc'    => __( 'Enable / Disable Windows Live Broadcast.' , $this->WPB_PREFIX),
		'std'     => 'true',
		'type'    => 'select',
		'section' => 'wsi_general',
		'choices' => array(
	...
	$this->settings['enable_mail'] = array(
		'title'   => __( 'Enabled' , $this->WPB_PREFIX),
		'desc'    => __( 'Enable / Disable Emails broadcast.' , $this->WPB_PREFIX),
		'std'     => 'true',
		'type'    => 'select',
		'section' => 'wsi_general',
		'choices' => array(
	...
	*/
	...
	$this->settings['subject'] = array(
		...
		'desc'    => __('Default Subject for broadcast',$this->WPB_PREFIX),
	...
	$this->settings['subject_editable'] = array(
		...
		'desc'    => __( 'Enable / Disable users to change the default subject. Facebook, Twitter and Linkedin don\'t use subject field' , $this->WPB_PREFIX). '<a href="http://www.WPSocialbroadcast.com" target="_blank" style="color:red"> (Premium Only)</a>',
		'std'     => 'true',
		'type'    => 'select',
		'disabled'=> 'yes',
		'section' => 'wsi_messages',
	...
	$this->settings['html_message'] = array(
		...
		'desc'    => __('Default Message for HTML Broadcast. <strong>Only supported by (Gmail, Yahoo, Foursquare and Live).</strong>',$this->WPB_PREFIX),
	...
	$this->settings['html_message_editable'] = array(
		'title'   => __( 'Editable' , $this->WPB_PREFIX),
		'desc'    => __( 'Enable / Disable users to change the default html message.' , $this->WPB_PREFIX). '<a href="http://www.WPSocialbroadcast.com" target="_blank" style="color:red"> (Premium Only)</a>',
		'std'     => 'true',
		'type'    => 'select',
		'disabled'=> 'yes',
		'section' => 'wsi_messages',
	...
	$this->settings['html_non_editable_message'] = array(
		...
		'std'     => __('Please accept the invitation in %%ACCEPTURL%% <br> Follow my twitter <a href="http://twitter.com/navnishbhardwaj">@navnishbhardwaj</a>', $this->WPB_PREFIX),
		'type'    => 'html',
		'section' => 'wsi_messages'
	);
	...
	$this->settings['footer'] = array(
		...
		'desc'    => __('The footer it\'s only used by email providers. A good practice is to add your company address to avoid spam filters' ,$this->WPB_PREFIX). '<a href="www.WPSocialbroadcast.com" target="_blank" style="color:red"> (Premium Only)</a>',
		'std'     => __('Powered by <a href="www.WPSocialbroadcast.com/">WP Social Broadcast</a>', $this->WPB_PREFIX),
		'type'    => 'disabled',
		'section' => 'wsi_messages'
	);
	...
	$this->settings['text_subject_editable'] = array(
		'title'   => __( 'Editable' , $this->WPB_PREFIX),
		'desc'    => __( 'Enable / Disable users to change the default subject. Linkedin policy says that users must be able to edit this' , $this->WPB_PREFIX). '<a href="http://www.WPSocialbroadcast.com" target="_blank" style="color:red"> (Premium Only)</a>',
		'std'     => 'true',
		'type'    => 'select',
		'disabled'=> 'yes',
		'section' => 'wsi_messages',
	...
	$this->settings['message'] = array(
		...
		'desc'    => sprintf(__('Default plain text Message for Linkedin broadcas.Keep it under 200 characters(%%ACCEPTURL%% will be converted to a 22 characters string) Characters left: %s',$this->WPB_PREFIX),'<span id="char_left_lk">200</span>'),
	...
	$this->settings['message_editable'] = array(
		'title'   => __( 'Editable' , $this->WPB_PREFIX),
		'desc'    => __( 'Enable / Disable users to change the default message. Linkedin policy says that users must be able to edit this' , $this->WPB_PREFIX). '<a href="http://www.WPSocialbroadcast.com" target="_blank" style="color:red"> (Premium Only)</a>',
		'std'     => 'true',
		'type'    => 'select',
		'disabled'=> 'yes',
		'section' => 'wsi_messages',
	...
	$this->settings['fb_message'] = array(
		'title'   => __( 'Text Message' , $this->WPB_PREFIX),
		'desc'    => __('Default plain text Message for Facebook broadcas.',$this->WPB_PREFIX),
	...
	$this->settings['fb_message_editable'] = array(
		'title'   => __( 'Editable' , $this->WPB_PREFIX),
		'desc'    => __( 'Enable / Disable users to change the default Facebook message.' , $this->WPB_PREFIX). '<a href="http://www.WPSocialbroadcast.com" target="_blank" style="color:red"> (Premium Only)</a>',
		'std'     => 'true',
		'type'    => 'select',
		'section' => 'wsi_messages',
		'disabled'=> 'yes',
	...
	$this->settings['tw_message_editable'] = array(
		'title'   => __( 'Editable' , $this->WPB_PREFIX),
		'desc'    => __( 'Enable / Disable users to change the default Twitter message.' , $this->WPB_PREFIX). '<a href="http://www.WPSocialbroadcast.com" target="_blank" style="color:red"> (Premium Only)</a>',
		'std'     => 'true',
		'type'    => 'select',
		'disabled'=> 'yes',
		'section' => 'wsi_messages',
	...
	*/
	...
	$this->settings['widget_order'] = array(
		...
		'desc'    => __('Drag and drop to order widget providers',$this->WPB_PREFIX). '<a href="http://www.WPSocialbroadcast.com" target="_blank" style="color:red"> (Premium Only)</a>',
		'std'     => WP_Social_Broadcast::get_providers(),
		'type'	  => 'sortable',
		'disabled'=> 'yes',
		'section' => 'wsi_styling'
	);
