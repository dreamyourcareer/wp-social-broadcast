...
<div class="postbox" id="sticky"> 
	<h3 style="cursor: default;" class="nowrap"><?php echo sprintf(__('Support %s', $this->WPB_PREFIX), $this->WPB_PLUGIN_NAME);?> </h3>
		<div class="inside">
				...
				<p>
						<a href="http://www.WPSocialbroadcast.com"><?php _e('Rate the plugin 5★', $this->WPB_PREFIX);?></a>
				</p>
				<p style="font-weigh:bold">
						<a href="http://www.WPSocialbroadcast.com" style="color:red"><?php _e('Get Premium Features', $this->WPB_PREFIX);?></a>
				</p>
				<p>
						<a href="<?php echo $this->WPB_PLUGIN_URL.'/'.$this->WPB_PREFIX.'.po';?>"><?php _e('Translate the plugin to your language', $this->WPB_PREFIX);?></a>
				</p>
				
				<b>WP Social Broadcast by:</b>
				<ul>
					<li><a href="http://www.WPSocialbroadcast.com">Karl Lillrud</a></li>
					<li><a href="http://dreamyourcareer.com/author/navnish/">Navnish Bhardwaj</a></li>
				</ul>
