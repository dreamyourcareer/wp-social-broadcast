...
// --------------------------------------------------------------------
@session_start();
$_SESSION["wsi::plugin"] = "WP Social Broadcast";
...
<head>
	...
	<title>WP Social Broadcast Test</title>
	<style>
...
<body>
	<h1 style="text-align:center;">WP Social Broadcast Test</h1>
	...
	<p>
		<b>WP Social Broadcast requirements are</b>: 
	</p>
	<ul style="margin-left:40px;margin-top:0px;">
